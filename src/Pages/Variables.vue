<template>
  <div class="tutorial"> 
    ...
    <div class="tutorial__body">
      ...
      <p>
        Keyword <code>let</code> the same as <code>var</code> but it has a <mark>block scope</mark>.
      </p>
      ...
      <p>
        The scope of a variable declared outside any function is <mark>global</mark>.
      </p>
    </div>
  </div>
</template>
