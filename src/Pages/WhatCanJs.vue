  ...
  <div class="tutorial"> 
    ...
    <div class="tutorial__body">
      ...
      <p>
        ...
        In a browser, JS can do all that related with page <mark>content manipulation</mark>, 
        <mark>user interaction</mark> and some extent, with a <mark>server</mark>:
      </p>
